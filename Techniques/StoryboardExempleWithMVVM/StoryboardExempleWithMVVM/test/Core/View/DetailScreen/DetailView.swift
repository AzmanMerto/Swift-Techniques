...
protocol DetailViewInterace: AnyObject{
    func configureVC()
...
extension DetailView: DetailViewInterace {
    func configureVC() {
    ...
    func configurePosterImageView() {
        ...
        NSLayoutConstraint.activate([
            ...
            posterImageView.leadingAnchor.constraint(equalTo: view.leftAnchor, constant: padding),
